...
tf.app.flags.DEFINE_string('data_dir', 'TestingData/CharacterDraw/',
                           """Directory containing training/testing images.""")
tf.app.flags.DEFINE_string('train_dir', 'checkpoint/Checkpoint/Character/',
                           """Directory where to write training logs.""")
tf.app.flags.DEFINE_string('test_dir', 'output_Character_train/',
                           """Directory where to write testing logs.""")
tf.app.flags.DEFINE_string('encode_dir', 'encode/',
...
def main(argv=None):
    ...
    if FLAGS.train:
        ...
        with tf.compat.v1.variable_scope("monnet") as scope:
    ...
    gpu_options = tf.compat.v1.GPUOptions(per_process_gpu_memory_fraction=FLAGS.gpu_fraction)
